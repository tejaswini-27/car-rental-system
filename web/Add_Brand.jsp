...
<div class="wrapper row1">
  <div id="topnav">
    <ul>
      ...
      <li class="active"><a href="Add_Brand.jsp"><strong>Add Brand</strong></a></li>
...
<div class="wrapper row2">
 ...
 <div id="homepage" class="clear">
       <center>
            ...
            <h2>Add Brand of Cars</h2>
         
            
          <form action="BrandAction.jsp" method="post">
                <table>
                    <tr><th>Brand Name</th><td><input type="text" name="bname" required=""></td></tr>
