...
<div class="wrapper row1">
  <div id="topnav">
    <ul>
      ...
      <li class="active"><a href="MyBooking.jsp"><strong>Book Cars</strong></a></li>
 ...
 <div id="homepage" class="clear">
       <center>
            ...
            <table>
                ...
                <%
                try{
                    ResultSet r=Queries.getExecuteQuery("select * from vehicle");
                    while(r.next()){
                        %>
                        <tr>
                            <td><%=r.getString(2)%></tD>
                            ...
                            <td><%=r.getString(5)%></tD>
                            <td><%=r.getString(6)%></tD>
                            <td><a href="MyBooking.jsp?vid=<%=r.getString(1)%>&price=<%=r.getString(4)%>">Book car</a></tD>
                        </tr>
